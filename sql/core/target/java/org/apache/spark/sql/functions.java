...
public  class functions {
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.Column split (org.apache.spark.sql.Column str, java.lang.String regex)  { throw new RuntimeException(); }
  /**
   * Splits str around matches of the given regex.
   * <p>
   * @param str a string expression to split
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.Column split (org.apache.spark.sql.Column str, java.lang.String regex, int limit)  { throw new RuntimeException(); }
  /**
   ...
   * <p>
   * See {@link java.time.format.DateTimeFormatter} for valid date and time format patterns
   * <p>
   * @param dateExpr A date, timestamp or string. If a string, the data must be in a format that
   *                 can be cast to a timestamp, such as <code>uuuu-MM-dd</code> or <code>uuuu-MM-dd HH:mm:ss.SSSS</code>
   * @param format A pattern <code>dd.MM.uuuu</code> would return a string like <code>18.03.1993</code>
   ...
   *          <code>uuuu-MM-dd HH:mm:ss</code> format
   ...
   *          cast to a date, such as <code>uuuu-MM-dd</code> or <code>uuuu-MM-dd HH:mm:ss.SSSS</code>
   ...
   * <p>
   * @param s A date, timestamp or string. If a string, the data must be in a format that can be
   *          cast to a timestamp, such as <code>uuuu-MM-dd</code> or <code>uuuu-MM-dd HH:mm:ss.SSSS</code>
   ...
   * @since 1.5.0
   *
   * @deprecated This function is deprecated and will be removed in future versions. Since 3.0.0. 
   */
   ...
   * @since 3.0.0
   * @param expr (undocumented)
   * @param zero (undocumented)
   * @param merge (undocumented)
   * @param finish (undocumented)
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.Column aggregate (org.apache.spark.sql.Column expr, org.apache.spark.sql.Column zero, scala.Function2<org.apache.spark.sql.Column, org.apache.spark.sql.Column, org.apache.spark.sql.Column> merge, scala.Function1<org.apache.spark.sql.Column, org.apache.spark.sql.Column> finish)  { throw new RuntimeException(); }
  /**
   * Applies a binary operator to an initial state and all elements in the array,
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.sql.Column aggregate (org.apache.spark.sql.Column expr, org.apache.spark.sql.Column zero, scala.Function2<org.apache.spark.sql.Column, org.apache.spark.sql.Column, org.apache.spark.sql.Column> merge)  { throw new RuntimeException(); }
  /**
