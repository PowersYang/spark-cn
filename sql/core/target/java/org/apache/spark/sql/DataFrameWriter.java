...
public final class DataFrameWriter<T extends java.lang.Object> {
   ...
   * <li><code>dateFormat</code> (default <code>uuuu-MM-dd</code>): sets the string that indicates a date format.
   * Custom date formats follow the formats at <code>java.time.format.DateTimeFormatter</code>.
   * This applies to date type.</li>
   * <li><code>timestampFormat</code> (default <code>uuuu-MM-dd'T'HH:mm:ss.SSSXXX</code>): sets the string that
   * indicates a timestamp format. Custom date formats follow the formats at
   * <code>java.time.format.DateTimeFormatter</code>. This applies to timestamp type.</li>
   ...
   * </ul>
   * <p>
   * When writing to data source v1, the default option is <code>ErrorIfExists</code>. When writing to data
   * source v2, the default option is <code>Append</code>.
   * <p>
   * @since 1.4.0
