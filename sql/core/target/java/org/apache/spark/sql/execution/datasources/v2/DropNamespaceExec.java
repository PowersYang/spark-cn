...
public  class DropNamespaceExec extends org.apache.spark.sql.execution.datasources.v2.V2CommandExec implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   DropNamespaceExec (org.apache.spark.sql.connector.catalog.SupportsNamespaces catalog, scala.collection.Seq<java.lang.String> namespace, boolean ifExists, boolean cascade)  { throw new RuntimeException(); }
