...
public  class ShuffleExchangeExec extends org.apache.spark.sql.execution.exchange.Exchange implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   ShuffleExchangeExec (org.apache.spark.sql.catalyst.plans.physical.Partitioning outputPartitioning, org.apache.spark.sql.execution.SparkPlan child, boolean canChangeNumPartitions)  { throw new RuntimeException(); }
  // not preceding
  ...
  public  org.apache.spark.sql.execution.ShuffledRowRDD createShuffledRDD (scala.Option<int[]> partitionStartIndices)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.execution.adaptive.LocalShuffledRowRDD createLocalShuffleRDD ()  { throw new RuntimeException(); }
