...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#singleInterval}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSingleInterval(SqlBaseParser.SingleIntervalContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code setDatabaseLocation}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSetDatabaseLocation(SqlBaseParser.SetDatabaseLocationContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code alterTableColumn}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAlterTableColumn(SqlBaseParser.AlterTableColumnContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#database}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDatabase(SqlBaseParser.DatabaseContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link SqlBaseParser#assign}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAssign(SqlBaseParser.AssignContext ctx);
	/**
