...
public  class AlterTableAlterColumnStatement extends org.apache.spark.sql.catalyst.plans.logical.ParsedStatement implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   AlterTableAlterColumnStatement (scala.collection.Seq<java.lang.String> tableName, scala.collection.Seq<java.lang.String> column, scala.Option<org.apache.spark.sql.types.DataType> dataType, scala.Option<java.lang.String> comment)  { throw new RuntimeException(); }
}
