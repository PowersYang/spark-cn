...
public abstract class AbstractSqlParser implements org.apache.spark.sql.catalyst.parser.ParserInterface, org.apache.spark.internal.Logging {
  ...
  /**
   * Creates {@link CalendarInterval} for a given SQL String. Throws {@link ParseException} if the SQL
   * string is not a valid interval format.
   * @param sqlText (undocumented)
   * @return (undocumented)
   */
  public  org.apache.spark.unsafe.types.CalendarInterval parseInterval (java.lang.String sqlText)  { throw new RuntimeException(); }
