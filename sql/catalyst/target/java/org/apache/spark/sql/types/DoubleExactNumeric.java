...
public  class DoubleExactNumeric {
  ...
  static public  boolean lteq (double x, double y)  { throw new RuntimeException(); }
  static public  boolean gteq (double x, double y)  { throw new RuntimeException(); }
  static public  boolean lt (double x, double y)  { throw new RuntimeException(); }
  static public  boolean gt (double x, double y)  { throw new RuntimeException(); }
  static public  boolean equiv (double x, double y)  { throw new RuntimeException(); }
  static public  double max (double x, double y)  { throw new RuntimeException(); }
  static public  double min (double x, double y)  { throw new RuntimeException(); }
