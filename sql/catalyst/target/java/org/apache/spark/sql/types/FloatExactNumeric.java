...
public  class FloatExactNumeric {
  ...
  static public  boolean lteq (float x, float y)  { throw new RuntimeException(); }
  static public  boolean gteq (float x, float y)  { throw new RuntimeException(); }
  static public  boolean lt (float x, float y)  { throw new RuntimeException(); }
  static public  boolean gt (float x, float y)  { throw new RuntimeException(); }
  static public  boolean equiv (float x, float y)  { throw new RuntimeException(); }
  static public  float max (float x, float y)  { throw new RuntimeException(); }
  static public  float min (float x, float y)  { throw new RuntimeException(); }
