...
public  class DateTimeFormatterHelper$ {
  ...
  public  com.google.common.cache.Cache<scala.Tuple2<java.lang.String, java.util.Locale>, java.time.format.DateTimeFormatter> cache ()  { throw new RuntimeException(); }
  ...
  public  java.time.format.DateTimeFormatter buildFormatter (java.lang.String pattern, java.util.Locale locale)  { throw new RuntimeException(); }
  // not preceding
