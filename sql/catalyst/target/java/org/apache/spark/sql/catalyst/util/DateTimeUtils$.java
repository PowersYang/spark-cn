...
public  class DateTimeUtils$ {
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.types.Decimal getSecondsWithFraction (long microsec, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.types.Decimal getMilliseconds (long timestamp, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getMicroseconds (long timestamp, java.util.TimeZone timeZone)  { throw new RuntimeException(); }
  /**
  ...
  public  int getMillennium (int date)  { throw new RuntimeException(); }
  /** Returns the century for the given date. The date is expressed in days since 1.1.1970. */
  public  int getCentury (int date)  { throw new RuntimeException(); }
  /** Returns the decade for the given date. The date is expressed in days since 1.1.1970. */
  public  int getDecade (int date)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  int getIsoYear (int date)  { throw new RuntimeException(); }
  /**
  ...
  public  int getLastDayOfMonth (int date)  { throw new RuntimeException(); }
    ...
    int TRUNC_TO_DECADE ()  { throw new RuntimeException(); }
    int TRUNC_TO_CENTURY ()  { throw new RuntimeException(); }
    int TRUNC_TO_MILLENNIUM ()  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.types.Decimal getEpoch (long timestamp, java.time.ZoneId zoneId)  { throw new RuntimeException(); }
