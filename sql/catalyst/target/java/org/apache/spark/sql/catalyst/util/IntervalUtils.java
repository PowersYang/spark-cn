...
public  class IntervalUtils {
  static public final  int MONTHS_PER_YEAR ()  { throw new RuntimeException(); }
  static public final  byte MONTHS_PER_QUARTER ()  { throw new RuntimeException(); }
  static public final  int YEARS_PER_MILLENNIUM ()  { throw new RuntimeException(); }
  static public final  int YEARS_PER_CENTURY ()  { throw new RuntimeException(); }
  static public final  int YEARS_PER_DECADE ()  { throw new RuntimeException(); }
  static public final  long MICROS_PER_HOUR ()  { throw new RuntimeException(); }
  static public final  long MICROS_PER_MINUTE ()  { throw new RuntimeException(); }
  static public final  byte DAYS_PER_MONTH ()  { throw new RuntimeException(); }
  static public final  long MICROS_PER_MONTH ()  { throw new RuntimeException(); }
  static public final  long MICROS_PER_YEAR ()  { throw new RuntimeException(); }
  static public  int getYears (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  static public  int getMillenniums (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  static public  int getCenturies (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  static public  int getDecades (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  static public  byte getMonths (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  static public  byte getQuarters (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  ...
  static public  long getMicroseconds (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  ...
  static public  org.apache.spark.sql.types.Decimal getMilliseconds (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  static public  org.apache.spark.sql.types.Decimal getEpoch (org.apache.spark.unsafe.types.CalendarInterval interval)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.unsafe.types.CalendarInterval fromString (java.lang.String str)  { throw new RuntimeException(); }
  /**
   * A safe version of <code>fromString</code>. It returns null for invalid input string.
   * @param str (undocumented)
   * @return (undocumented)
   */
  static public  org.apache.spark.unsafe.types.CalendarInterval safeFromString (java.lang.String str)  { throw new RuntimeException(); }
  /**
   ...
   * @return (undocumented)
   */
  static public  org.apache.spark.unsafe.types.CalendarInterval fromDayTimeString (java.lang.String input, java.lang.String from, java.lang.String to)  { throw new RuntimeException(); }
  static public  org.apache.spark.unsafe.types.CalendarInterval fromUnitStrings (java.lang.String[] units, java.lang.String[] values)  { throw new RuntimeException(); }
  /**
