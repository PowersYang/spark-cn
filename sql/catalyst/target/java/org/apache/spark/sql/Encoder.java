...
public  interface Encoder<T extends java.lang.Object> extends scala.Serializable {
  ...
  /**
   * Create a copied {@link Encoder}. The implementation may just copy internal reusable fields to speed
   * up the {@link Encoder} creation.
   * @return (undocumented)
   */
  public  org.apache.spark.sql.Encoder<T> makeCopy ()  ;
