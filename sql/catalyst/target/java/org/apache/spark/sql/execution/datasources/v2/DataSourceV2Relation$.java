...
public  class DataSourceV2Relation$ implements scala.Serializable {
  ...
  public  org.apache.spark.sql.execution.datasources.v2.DataSourceV2Relation create (org.apache.spark.sql.connector.catalog.Table table, org.apache.spark.sql.util.CaseInsensitiveStringMap options)  { throw new RuntimeException(); }
  public  org.apache.spark.sql.execution.datasources.v2.DataSourceV2Relation create (org.apache.spark.sql.connector.catalog.Table table)  { throw new RuntimeException(); }
  /**
