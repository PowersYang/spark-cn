 ...
 */
   ...
   * @return (undocumented)
   */
  public  scala.Tuple2<java.util.List<org.apache.kafka.clients.consumer.ConsumerRecord<byte[], byte[]>>, java.lang.Object> fetch (long offset, long pollTimeoutMs)  { throw new RuntimeException(); }
  /**
