 ...
 */
  ...
  static   class CachedFetchedData implements scala.Product, scala.Serializable {
    // not preceding
    public   CachedFetchedData (org.apache.spark.sql.kafka010.FetchedData fetchedData)  { throw new RuntimeException(); }
    public  org.apache.spark.sql.kafka010.FetchedData fetchedData ()  { throw new RuntimeException(); }
    public  org.apache.spark.sql.kafka010.FetchedData getObject ()  { throw new RuntimeException(); }
  ...
  public  org.apache.spark.sql.kafka010.FetchedData acquire (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key, long desiredStartOffset)  { throw new RuntimeException(); }
  public  void invalidate (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key)  { throw new RuntimeException(); }
  public  void release (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key, org.apache.spark.sql.kafka010.FetchedData fetchedData)  { throw new RuntimeException(); }
