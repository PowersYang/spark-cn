 ...
 */
  ...
  static public  class PoolConfig extends org.apache.commons.pool2.impl.GenericKeyedObjectPoolConfig<org.apache.spark.sql.kafka010.InternalKafkaConsumer> {
  ...
  static public  class ObjectFactory extends org.apache.commons.pool2.BaseKeyedPooledObjectFactory<org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey, org.apache.spark.sql.kafka010.InternalKafkaConsumer> {
    public   ObjectFactory ()  { throw new RuntimeException(); }
    public  org.apache.spark.sql.kafka010.InternalKafkaConsumer create (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key)  { throw new RuntimeException(); }
    public  void destroyObject (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key, org.apache.commons.pool2.PooledObject<org.apache.spark.sql.kafka010.InternalKafkaConsumer> p)  { throw new RuntimeException(); }
    public  java.util.concurrent.ConcurrentHashMap<org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey, java.util.Map<java.lang.String, java.lang.Object>> keyToKafkaParams ()  { throw new RuntimeException(); }
    public  org.apache.commons.pool2.PooledObject<org.apache.spark.sql.kafka010.InternalKafkaConsumer> wrap (org.apache.spark.sql.kafka010.InternalKafkaConsumer value)  { throw new RuntimeException(); }
  }
  public   InternalKafkaConsumerPool (org.apache.spark.sql.kafka010.InternalKafkaConsumerPool.ObjectFactory objectFactory, org.apache.spark.sql.kafka010.InternalKafkaConsumerPool.PoolConfig poolConfig)  { throw new RuntimeException(); }
   ...
   * @return (undocumented)
   */
  public  org.apache.spark.sql.kafka010.InternalKafkaConsumer borrowObject (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key, java.util.Map<java.lang.String, java.lang.Object> kafkaParams)  { throw new RuntimeException(); }
  /** Returns borrowed object to the pool. */
  public  void returnObject (org.apache.spark.sql.kafka010.InternalKafkaConsumer consumer)  { throw new RuntimeException(); }
  /** Invalidates (destroy) borrowed object to the pool. */
  public  void invalidateObject (org.apache.spark.sql.kafka010.InternalKafkaConsumer consumer)  { throw new RuntimeException(); }
  /** Invalidates all idle consumers for the key */
  public  void invalidateKey (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key)  { throw new RuntimeException(); }
  /**
  ...
  public  int numIdle (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key)  { throw new RuntimeException(); }
  public  int numActive ()  { throw new RuntimeException(); }
  public  int numActive (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key)  { throw new RuntimeException(); }
  public  int size ()  { throw new RuntimeException(); }
  public  int size (org.apache.spark.sql.kafka010.KafkaDataConsumer.CacheKey key)  { throw new RuntimeException(); }
}
