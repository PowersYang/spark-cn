 ...
 */
 abstract class MapOutputTracker implements org.apache.spark.internal.Logging {
   ...
   */
  static public  scala.collection.Iterator<scala.Tuple2<org.apache.spark.storage.BlockManagerId, scala.collection.Seq<scala.Tuple3<org.apache.spark.storage.BlockId, java.lang.Object, java.lang.Object>>>> convertMapStatuses (int shuffleId, int startPartition, int endPartition, org.apache.spark.scheduler.MapStatus[] statuses, scala.Option<java.lang.Object> mapIndex)  { throw new RuntimeException(); }
   ...
   * @param endPartition (undocumented)
   */
  public abstract  scala.collection.Iterator<scala.Tuple2<org.apache.spark.storage.BlockManagerId, scala.collection.Seq<scala.Tuple3<org.apache.spark.storage.BlockId, java.lang.Object, java.lang.Object>>>> getMapSizesByMapIndex (int shuffleId, int mapIndex, int startPartition, int endPartition)  ;
  /**
